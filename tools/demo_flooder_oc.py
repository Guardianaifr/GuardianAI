...
# Configuration for OpenClaw Real-Time Demo
URL = "http://localhost:8081/v1/chat/completions"
# Using the token configured in guardian/config/config.yaml for proxy.enforce_auth
TOKEN = "pt-guardian-789" 
    ...
    try:
        ...
        if status == 429:
            ...
            print(f"Request {i}: ✅ ALLOWED (200 OK) - {int(duration)}ms")
             ...
             print(f"Request {i}: ⛔ AUTH FAIL ({status}) - Check Token!")
        else:
